# Generated data migration: начальные товары для редактирования в админке
...
def unload_products(apps, schema_editor):
    Product = apps.get_model('main', 'Product')
    slugs = ['drel-udarnaya-gsb-18v-50', 'ushm-125-900', 'perforator-gbh-2-26', 'lazernyj-uroven-360', 'shurupovert-18v', 'invertor-svarochnyj-200']
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(load_products, unload_products),
    ]
